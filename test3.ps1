...
# $PSScriptRoot is another built-in automatic variable that contains the folder path where the script is located (without the filename).Note : this will not work when compiled to .exe , this will be empty   
